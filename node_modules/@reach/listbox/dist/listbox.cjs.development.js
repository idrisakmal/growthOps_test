...
function listboxLostFocus(data, event) {
  if (event.type === ListboxEvents.Blur) {
    ...
    var ownerDocument = popover && utils.getOwnerDocument(popover) || document;
...
var ListboxList = /*#__PURE__*/utils.forwardRefWithAs(function ListboxList(_ref7, forwardedRef) {
  ...
  var _useContext4 = React.useContext(ListboxContext),
...
var ListboxGroupLabel = /*#__PURE__*/utils.forwardRefWithAs(function ListboxGroupLabel(_ref10, forwardedRef) {
  ...
  var _useContext7 = React.useContext(ListboxGroupContext),
...
//# sourceMappingURL=listbox.cjs.development.js.map
